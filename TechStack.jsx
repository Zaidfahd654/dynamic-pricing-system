  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      {techs.map((tech, i) => (
        <div
          key={i}
          className="flex items-start gap-4 p-5 rounded-2xl bg-card border hover:shadow-lg transition-all duration-300"
        >
          ...
          <div>
            ...
            <p className="text-xs mt-1 leading-relaxed">{tech.desc}</p>
          </div>
        </div>
      ))}
    </div>
